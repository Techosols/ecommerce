-- migrate:ignore
-- 0008_cart.sql — NOT A MIGRATION. Safe to delete; deleting it is the right fix.
--
-- This file is a leftover from an early draft of the schema that was renumbered
-- before any of it shipped. It created carts, cart_items,
-- which 0010_carts.sql creates properly — and because the runner

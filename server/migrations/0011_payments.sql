-- migrate:ignore
-- 0011_payments.sql — NOT A MIGRATION. Safe to delete; deleting it is the right fix.
--
-- This file is a leftover from an early draft of the schema that was renumbered
-- before any of it shipped. It created payments, payment_webhook_logs,
-- which 0012_payments.sql creates properly — and because the runner
